...
-- Compiled business ontology (nodes/edges/glossary), generated by
-- ontology/gen_ontology.py and queried by the `ontology` toolset in
-- tools.yaml. Lives only on THIS server: quack-server-2 mounts
-- seed-inventory.sql over /quack/seed.sql, and quack-server-3 uses
-- its own init template, so neither reads this file.
.read /quack/seed-ontology.sql
